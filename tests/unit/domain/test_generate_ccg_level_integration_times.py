...
def test_returns_table_with_ccg_level_integration_times_columns_with_integrated_within_3_days():
...
@pytest.mark.filterwarnings("ignore:Conversion of")
def test_returns_table_with_ccg_level_integration_times_columns_without_integrated_within_3_days():
    requesting_practice_name = a_string(6)
    requesting_practice_ods_code = a_string(6)
    requesting_practice_ccg_ods_code = a_string(3)
    requesting_practice_ccg_name = a_string(6)
