...
from prmreportsgenerator.domain.custom_reporting_window import CustomReportingWindow
...
def test_throws_value_error_given_end_datetime_but_no_start_datetime():
    ...
    with pytest.raises(ValueError) as e:
        CustomReportingWindow(start_datetime=None, end_datetime=end_datetime)
